class Form
  ...
  attr_accessor :item_id, :user_id, :postal_code, :prefecture_id, :municipality, :address, :building_name, :phone_nu,
                :purchase_information_id, :token
  ...
  def save
    ...
    ShippingAddress.create(postal_code: postal_code, prefecture_id: prefecture_id, municipality: municipality,
                           address: address, phone_nu: phone_nu, purchase_information_id: purchase_information.id)
  end
end
